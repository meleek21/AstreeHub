...
namespace ASTREE_PFE.Controllers
{
    ...
    public class ReactionController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Reaction>>> GetReactionsByEmployee(
            string employeeId
        )
        {
        ...
        public async Task<ActionResult<Reaction>> GetReactionByEmployeeAndPost(
            string employeeId,
            string postId
        )
        {
            var reaction = await _reactionService.GetReactionByEmployeeAndPostAsync(
                employeeId,
                postId
            );
            if (reaction == null)
