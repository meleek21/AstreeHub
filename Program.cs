...
builder.Services.AddScoped<IMongoRepository<Comment>>(sp => new MongoRepository<Comment>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Comments"
));
builder.Services.AddScoped<IMongoRepository<Post>>(sp => new MongoRepository<Post>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Posts"
));
...
builder.Services.AddScoped<IMongoRepository<Reaction>>(sp => new MongoRepository<Reaction>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Reactions"
));
builder.Services.AddScoped<IMongoRepository<Channel>>(sp => new MongoRepository<Channel>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Channels"
));
builder.Services.AddScoped<IMongoRepository<Message>>(sp => new MongoRepository<Message>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Messages"
));
builder.Services.AddScoped<IMongoRepository<Conversation>>(sp => new MongoRepository<Conversation>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Conversations"
));
builder.Services.AddScoped<IMongoRepository<Event>>(sp => new MongoRepository<Event>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Events"
));
builder.Services.AddScoped<IMongoRepository<UserOnlineStatus>>(
    sp => new MongoRepository<UserOnlineStatus>(
        sp.GetRequiredService<IMongoDatabase>(),
        "UserOnlineStatus"
    )
);
builder.Services.AddScoped<IMongoRepository<Todo>>(sp => new MongoRepository<Todo>(
    sp.GetRequiredService<IMongoDatabase>(),
    "Todos"
));
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc(
        "v1",
        new Microsoft.OpenApi.Models.OpenApiInfo { Title = "ASTREE_PFE API", Version = "v1" }
    );
